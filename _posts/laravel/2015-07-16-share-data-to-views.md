...
而我們可以從Model和View的關係入手, 我們之前學過在Controller再把Model的資料轉為Array, 最後Pass給View顯示資料內容。但現在我們可以用View Composer, 令到Model資料跟View直接綁定。因為有很多資料很常用, 每次使用時在Controller重寫, 倒不如View直接透過View Composer找Model取資料。
